...
## ☁️ Firebase-Synchronisierung

Es gibt jetzt eine optionale Firebase-Integration in `public/firebase-db.js`.
- Füge deine Firebase-Projektkonfiguration in `public/firebase-db.js` ein.
- Öffne `public/index.html` und `public/admin.html` nach dem Eintrag deiner Firebase-Daten erneut.
- Dann werden Änderungen in Firestore gespeichert und bei allen Geräten automatisch synchronisiert.
